#!/usr/bin/env bash
# ============================================================
#  VOXEL-CHUNK, 150 EPOCHS: same recipe, 2.5x the schedule
#  The 60-epoch run (logs/20260728_111800, mIoU 56.45) was still improving when the
#  cosine hit its floor: val_acc slope over the last 15 epochs was +0.113 pt/epoch vs
#  EXP1 0.018, and its overfit gap was HALF the baseline (0.106 vs 0.243). Length only
#  hurt before (150-ep block run, -0.68) because nothing regularized it; with valid
#  strong augmentation on 7D features that objection is gone.
#
